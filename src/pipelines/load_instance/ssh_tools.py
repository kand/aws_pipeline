...
class sshConnection(object):
    ...
    def __init__(self, serveraddress, port, username, privatekeyfile):
        ...
        self._ssh.set_missing_host_key_policy(par/config" amiko.AutoAddPolicy())
        ...
        while not self._shell.recv_ready() and not self._shell.recv_stderr_ready(): pass
        print("_______STD OUT________")
        print(self._shell.recv(9999))
        print("_______STD ERR________")
        print(self._shell.recv_stderr(9999))
